...
import fr.theorozier.procgen.common.world.feature.Feature;
...
import fr.theorozier.procgen.common.world.feature.placement.Placement;
import fr.theorozier.procgen.common.world.feature.placement.Placements;
import fr.theorozier.procgen.common.world.feature.placement.config.*;
...
public abstract class Biome {
	...
	public Biome(int uid, String identifier, float depth, float scale, BiomeSurface surface, BiomeSurface underwaterSurface) {
		...
		this.foliageColor = new Color(85, 153, 69);
